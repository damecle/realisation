...
$.getJSON('https://jewel998.github.io/playlist/playlist.json',function(data){
   ...
   /* function centerize() {
    ...
    //nNOMNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN
    ...
    function processTime(time){
        var b = parseInt(time/60000);
        var c = parseInt((time%60000)/1000);
        if(c < 10){ c = "0"+c; }
        return b+":"+c;
    }
    function reset(){
  ...
  /*  function setPlaylist(){
        for(var i=0;i<playlist.songs.length;i++){
            $.getJSON(playlist.songs[i].json,function(i){ 
                return function(data){addToPlayList(data,i)}; }(i));
        }
    }*/
// PAS de fonctions
